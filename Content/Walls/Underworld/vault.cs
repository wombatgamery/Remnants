...
namespace Remnants.Content.Walls.Underworld
{
    public class vault : ModWall
    {
        ...
        //    return EmptyTile(i, j) && EmptyTile(i, j - 1) && EmptyTile(i, j - 2) && tile.HasTile && (tile.TileType == ModContent.TileType<PrototypePlating>() || tile.TileType == ModContent.TileType<PrototypePlatform>());
        //}

        //private bool EmptyTile(int i, int j)
        //{
        //    Tile tile = Main.tile[i, j];
        //    return !tile.HasTile || tile.TileType != ModContent.TileType<PrototypePlating>() && tile.TileType != ModContent.TileType<PrototypePipe>();
        //}

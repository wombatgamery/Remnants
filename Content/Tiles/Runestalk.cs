...
namespace Remnants.Content.Tiles
{
	...
	public class Runestalk : ModTile
	{
		...
		private void DrawCrystal(int i, int j, Color color1, Color color2, bool flip)
        {
			...
			Main.spriteBatch.Draw(ModContent.Request<Texture2D>(Texture + "Crystal").Value, position, sourceRectangle, avgColor, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
			Main.spriteBatch.Draw(ModContent.Request<Texture2D>(Texture + "CrystalHighlight").Value, position, sourceRectangle, color1, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
			Main.spriteBatch.Draw(ModContent.Request<Texture2D>(Texture + "CrystalBacklight").Value, position, sourceRectangle, color2, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
			Main.spriteBatch.Draw(ModContent.Request<Texture2D>(Texture + "CrystalShine").Value, position, sourceRectangle, Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
		}

...
using Remnants.Content.Items;
using Remnants.Content.Tiles;
using Remnants.Content.Dusts;
using Remnants.Content.Items.Materials;
using Remnants.Content.Items.Placeable.Objects;
using System;
using Terraria;
...
namespace Remnants.Content.Tiles.Plants
{
	...
	public class Runestalk : ModTile
	{
		...
		private void DrawCrystal(int i, int j, Color color1, Color color2, bool flip)
        {
			...
			Main.spriteBatch.Draw(ModContent.Request<Texture2D>("Remnants/Content/Tiles/Plants/RunestalkCrystal").Value, position, sourceRectangle, avgColor, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
			Main.spriteBatch.Draw(ModContent.Request<Texture2D>("Remnants/Content/Tiles/Plants/RunestalkCrystalHighlight").Value, position, sourceRectangle, color1, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
			Main.spriteBatch.Draw(ModContent.Request<Texture2D>("Remnants/Content/Tiles/Plants/RunestalkCrystalBacklight").Value, position, sourceRectangle, color2, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
			Main.spriteBatch.Draw(ModContent.Request<Texture2D>("Remnants/Content/Tiles/Plants/RunestalkCrystalShine").Value, position, sourceRectangle, Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
		}

...
namespace Remnants.Content.Projectiles.Enemy
{
  ...
  //      public override void OnHitPlayer(Player target, Player.HurtInfo info)
        ...
        public override void PostDraw(Color lightColor)
        {
			...
			Main.spriteBatch.Draw(ModContent.Request<Texture2D>("Remnants/Content/Projectiles/Enemy/AetherButterfly").Value, drawPos, rect, Color.White, Projectile.rotation, drawOrigin, Projectile.scale, SpriteEffects.None, 0f);
			Main.spriteBatch.Draw(ModContent.Request<Texture2D>("Remnants/Content/Projectiles/Enemy/AetherButterflyGlow").Value, drawPos, rect, RemTile.MagicalLabLightColour((int)Main.GameUpdateCount + Projectile.whoAmI), Projectile.rotation, drawOrigin, Projectile.scale, SpriteEffects.None, 0f);
		}

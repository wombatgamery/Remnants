...
{
	public class cursedflamejet : ModProjectile
	{
		public override string Texture => "Terraria/Images/Projectile_" + ProjectileID.IchorSplash;
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Cursed Flame Jet"); // The English name of the projectile
		}
		...
		public override void AI()
		{
			...
			{
				dustIndex = Dust.NewDust(Projectile.position, (int)(Projectile.width * Projectile.scale), (int)(Projectile.height * Projectile.scale), 75, Scale: Main.rand.Next(1, 4) * Projectile.scale);
		...
		{
			target.AddBuff(BuffID.CursedInferno, 20 * 60); //Gives cursed flames to target for 4 seconds. (60 = 1 second, 240 = 4 seconds)
		}

		public override void OnHitPlayer(Player target, Player.HurtInfo info)
		{
			target.AddBuff(BuffID.CursedInferno, 20 * 60, false);
		}
		...
		public override bool OnTileCollide(Vector2 oldVelocity)
		{
			...
			{
				Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position, Vector2.Zero, ModContent.ProjectileType<cursedburn>(), 12, 0f, Projectile.owner);
			}
			return false;
		}

...
{
	public class SpectralLanceHoldout : ModProjectile
	{
        public override LocalizedText DisplayName => Language.GetText("Mods.Remnants.Items.SpectralLance.DisplayName");
        ...
        protected virtual float HoldoutRangeMin => 64f;
		protected virtual float HoldoutRangeMax => 192f;

		public override void SetDefaults()
		{
			Projectile.CloneDefaults(ProjectileID.Spear); // Clone the default values for a vanilla spear. Spear specific values set for width, height, aiStyle, friendly, penetrate, tileCollide, scale, hide, ownerHitCheck, and melee.

			Projectile.width = 72 * 2;
			Projectile.height = 72 * 2;
			Projectile.scale = 1;

...
//                    if (attackTimer >= 60 && !NPC.wet)
//                    {
//                        Vector2 num712 = (Vector2.Normalize(Main.player[NPC.target].Center - NPC.Center) * 7.5f).RotatedByRandom(0.1f);

//                        int num228 = Projectile.NewProjectile(NPC.GetSource_FromAI(), NPC.Center, num712, ModContent.ProjectileType<fireball>(), 30, 0f, Main.myPlayer);
//                        NPC.netUpdate = true;
...
//            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("Remnants/Content/NPCs/Monsters/TheVault/flamerglow").Value, position, rect, glowColor * 255, NPC.rotation, Vector2.Zero, 1f, NPC.direction == 1 ? SpriteEffects.FlipHorizontally : SpriteEffects.None, 0f);
//        }

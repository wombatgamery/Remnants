...
//            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("Remnants/Content/NPCs/Monsters/TheVault/shockerglow").Value, position, rect, glowColor * 255, NPC.rotation, Vector2.Zero, 1f, NPC.direction == 1 ? SpriteEffects.FlipHorizontally : SpriteEffects.None, 0f);
//            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("Remnants/Content/NPCs/Monsters/TheVault/shockerglow2").Value, position, rect, Color.White, NPC.rotation, Vector2.Zero, 1f, NPC.direction == 1 ? SpriteEffects.FlipHorizontally : SpriteEffects.None, 0f);

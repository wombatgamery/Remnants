...
{
	public class MarbleDroplet : ModGore
	{
		...
		public override bool Update(Gore gore)
		{
			...
			if (gore.frame <= 4)
			{
				...
				if ((int)gore.frameCounter >= frameDuration)
				{
					...
					if (gore.frame == 5)
					{
						int droplet = Gore.NewGore(new EntitySource_TileUpdate(tileX, tileY), gore.position, gore.velocity, gore.type, 1f);
			...
			//Lighting.AddLight(gore.position, (float)(255f / 255f), (float)(170f / 255f), (float)(55f / 255f));

...
namespace Remnants.NPCs.Monsters.TheVault
{
    public class Icer : ModNPC
    {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            Main.spriteBatch.Draw(ModContent.Request<Texture2D>("Remnants/NPCs/Monsters/TheVault/icerglow").Value, position, rect, glowColor * 255, NPC.rotation, Vector2.Zero, 1f, NPC.direction == 1 ? SpriteEffects.FlipHorizontally : SpriteEffects.None, 0f);
        }

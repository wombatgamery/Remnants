...
public class CloudyMusicBox : ModItem
{
    ...
    {
        Item.ResearchUnlockCount = 1;
        MusicLoader.AddMusicBox(Mod, MusicLoader.GetMusicSlot(Mod, "Sounds/Music/GardenWater"), ModContent.ItemType<CloudyMusicBox>(), ModContent.TileType<CloudyMusicBoxTile>());
    }

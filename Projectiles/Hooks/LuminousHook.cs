...
namespace Remnants.Projectiles.Hooks
{
	public class LuminousHook : ModProjectile
	{
		...
		{
			chainTexture = ModContent.Request<Texture2D>("Remnants/Projectiles/Hooks/LuminousHookChain");
		}
        ...
        public override bool PreDrawExtras()
        {
            ...
            {
                //Asset<Texture2D> chainTexture = ModContent.Request<Texture2D>("Remnants/Projectiles/Hooks/LuminousHookChain");

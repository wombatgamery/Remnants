...
namespace Remnants.Tiles.Objects.Hazards
{
  ...
  //      {
		...
		//	{
		//		Main.spriteBatch.Draw(ModContent.Request<Texture2D>("Remnants/NPCs/enemies/mazeguardian").Value, new Vector2((i + 8) * 16 - (int)Main.screenPosition.X - 2, (j + 11) * 16 - (int)Main.screenPosition.Y - 2), new Rectangle(0, 0, 180, 180), Lighting.GetColor(i + 1, j + 4));
		//	}
		//}
    }

...
namespace Remnants.Tiles.Objects
{
	...
	public class LabyrinthAltar : ModTile
	{
        ...
        public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconText = Language.GetTextValue("Mods.Remnants.Tiles.LabyrinthAltar.MouseOver.Essence") + (style == 2 ? Language.GetTextValue("Mods.Remnants.Tiles.LabyrinthAltar.MouseOver.Focus" : style == 1 ? Language.GetTextValue("Mods.Remnants.Tiles.LabyrinthAltar.MouseOver.Endurance") : LanguageGetTextValue("Mods.Remnants.Tiles.LabyrinthAltar.MouseOver.Might");
		}

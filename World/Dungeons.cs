...
namespace Remnants.World
{
    public class TheDungeon : GenPass
    {
        ...
        {
            progress.Message = Main.NewText(Language.GetTextValue("Mods.Remnants.WorldgenMessages.Dungeon"));
    ...
    public class Undergrowth : GenPass
    {
        ...
        protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
        {
            progress.Message = Main.NewText(Language.GetTextValue("Mods.Remnants.WorldgenMessages.Undergrowth"));
    ...
    public class AerialGarden : GenPass
    {
        ...
        protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
        {
            progress.Message = Main.NewText(Language.GetTextValue("Mods.Remnants.WorldgenMessages.AerialGarden"));
    ...
    public class Pyramid : GenPass
    {
        ...
        protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
        {
            ...
            progress.Message = Main.NewText(Language.GetTextValue("Mods.Remnants.WorldgenMessages.Pyramid"));
    ...
    public class ForgottenTomb : GenPass
    {
        ...
        protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
        {
            progress.Message = Main.NewText(Language.GetTextValue("Mods.Remnants.WorldgenMessages.Tomb"));
    ...
    public class HoneySanctum : GenPass
    {
        ...
        protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
        {
            ...
            progress.Message = Main.NewText(Language.GetTextValue("Mods.Remnants.WorldgenMessages.HoneySanctum"));
    ...
    public class WaterTemple : GenPass
    {
        ...
        protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
        {
            progress.Message = Main.NewText(Language.GetTextValue("Mods.Remnants.WorldgenMessages.WaterTemple"));
    ...
    public class InfernalStronghold : GenPass
    {
        ...
        protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
        {
            progress.Message = Main.NewText(Language.GetTextValue("Mods.Remnants.WorldgenMessages.Stronghold"));
    ...
    public class MagicalLab : GenPass
    {
        ...
        protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
        {
            ...
            progress.Message = Main.NewText(Language.GetTextValue("Mods.Remnants.WorldgenMessages.MagicalLab"));
    ...
    public class Labyrinth : GenPass
    {
        ...
        protected override void ApplyPass(GenerationProgress progress, GameConfiguration configuration)
        {
            progress.Message = Main.NewText(Language.GetTextValue("Mods.Remnants.WorldgenMessages.Labyrinth"));
